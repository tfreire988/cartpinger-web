      ...
      <div className="container">
        ...
        <div className="steps">
          ...
          <div className="surface step featured reveal" data-delay="200">
            ...
            <p><a href="https://github.com/tfreire988/whatscom/blob/main/documentacion.md" target="_blank" rel="noopener" style={{ color: "var(--mint)", textDecoration: "underline" }}>Step-by-step documentation on GitHub</a>. Stuck? Direct support.</p>
            ...
            <div className="calc-out">
              ...
              <div className="calc-meta">
                ...
                <div style={{ fontSize: 11.5, color: "var(--text-3)", marginTop: 6 }}>
                  Assuming 50% WhatsApp recovery rate · AOV €60 · indicative estimate, not a guarantee.
                </div>
              </div>
            </div>
          </div>
