    ...
    <section className="section" id="producto">
      <div className="container">
        <div className="section-hed reveal">
          ...
          <p className="lede">El onboarding de Meta Business es donde otros plugins te abandonan. Aquí no. <a href="/docs/setup/" className="inline-video-link">▶ Mira el setup completo en vídeo (15 min)</a></p>
        </div>
        <div className="steps">
          ...
          <div className="surface step featured reveal" data-delay="200">
            ...
            <p><a href="https://github.com/tfreire988/cartpinger-web/blob/main/documentacion.md" target="_blank" rel="noopener" style={{ color: "var(--mint)", textDecoration: "underline" }}>Documentación paso a paso en GitHub</a>. Si te atascas, soporte directo.</p>
