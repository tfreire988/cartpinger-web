      ...
      <div className="container">
        ...
        <div className="steps">
          ...
          <div className="surface step featured reveal" data-delay="200">
            ...
            <p><a href="https://cartpinger.com/docs" target="_blank" rel="noopener" style={{ color: "var(--mint)", textDecoration: "underline" }}>Documentación paso a paso</a>. Si te atascas, soporte directo.</p>
